...
import EquipmentImportClient from '@/src/components/imports/EquipmentImportClient'
        ...
        <header className="overflow-hidden rounded border border-slate-300 bg-white shadow-sm">
          <div className="flex flex-col gap-3 border-b border-slate-300 bg-slate-900 px-4 py-3 text-white xl:flex-row xl:items-center xl:justify-between">
            <div>
              ...
              <h1 className="text-xl font-semibold">Importacion de equipos desde Excel</h1>
            </div>
          ...
          <div className="grid gap-px bg-slate-200 md:grid-cols-4">
            <div className="bg-white px-3 py-2">
              ...
              <p className="mt-1 font-mono text-sm font-semibold text-slate-950">Equipos</p>
            </div>
            <div className="bg-white px-3 py-2">
            ...
            <div className="bg-white px-3 py-2">
              ...
              <p className="mt-1 font-mono text-sm font-semibold text-slate-950">codigo, descripcion, unidad, tarifa, cpc, vae</p>
            </div>
            <div className="bg-white px-3 py-2">
              <p className="text-[11px] font-semibold uppercase tracking-wide text-slate-500">Destino</p>
              <p className="mt-1 font-mono text-sm font-semibold text-slate-950">Catalogo de equipos</p>
            </div>
          </div>
        </header>

        <div className="mt-4">
          <EquipmentImportClient />
        </div>
      </div>
    </div>
  )
