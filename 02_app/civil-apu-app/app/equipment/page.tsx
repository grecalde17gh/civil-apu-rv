          ...
          <aside className="overflow-hidden rounded border border-slate-300 bg-white shadow-sm">
            ...
            <div className="space-y-3 p-3">
              <label className="text-[11px] font-semibold uppercase tracking-wide text-slate-500">
                Buscar
                <input type="search" list="equipment-search-options" placeholder="Codigo o descripcion" className="mt-1 h-8 w-full rounded border border-slate-300 px-2 text-sm" />
            ...
            <div className="overflow-x-auto">
              <table id="equipment-table" className="min-w-full divide-y divide-slate-200 text-left text-xs">
                ...
                <tbody className="divide-y divide-slate-200">
                  {items.length === 0 ? (
                    <tr>
                      <td colSpan={7} className="px-3 py-10 text-center text-sm text-slate-500">No hay equipos registrados.</td>
                    </tr>
                  ) : (
                    items.map((item) => (
