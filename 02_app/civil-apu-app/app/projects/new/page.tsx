    ...
    <div className="min-h-screen bg-zinc-50 py-10 px-4 sm:px-6 lg:px-8">
      <div className="mx-auto max-w-3xl">
        <div className="mb-8 flex flex-col gap-4 sm:flex-row sm:items-end sm:justify-between">
          <div>
            <p className="text-sm font-semibold uppercase tracking-wide text-zinc-500">Proyecto nuevo</p>
            <h1 className="mt-2 text-3xl font-semibold text-zinc-950">Crear proyecto</h1>
          </div>
          <Link
            href="/projects"
